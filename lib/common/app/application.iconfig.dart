...
import 'package:flyme_app/feature/auth/infrastructure/repository/login_repository.dart';
import 'package:flyme_app/feature/auth/domain/repository/login_repository.dart';
import 'package:flyme_app/feature/auth/application/use_case/login_use_case.dart';
...
void $initGetIt(GetIt g, {String environment}) {
  g.registerFactory<AuthViewModel>(() => AuthViewModel());
  ...
  g.registerLazySingleton<ILoginLocalDataSource>(
      () => LoginLocalDataSource(g<DBService>()));
  ...
  g.registerLazySingleton<ILoginRemoteDataSource>(
      () => LoginRemoteDataSource(g<NetworkService>()));
  g.registerLazySingleton<ILoginRepository>(() =>
      LoginRepository(g<ILoginLocalDataSource>(), g<ILoginRemoteDataSource>()));
  g.registerLazySingleton<ILoginUseCase>(
      () => LoginUseCase(g<ILoginRepository>()));
